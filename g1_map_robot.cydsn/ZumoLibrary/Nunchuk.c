/**
 * @file    Nunchuk.c
 * @brief   Basic methods for operating wii nunchuck. For more details, please
 * refer to Nunchuk.h file.
 * @details
 */
#include "Nunchuk.h"
#include "FreeRTOS.h"
 ...
 * @details  write value(0x00) to register(address - 0x40) to initialize
 * nunchuk
 */
void
nunchuk_init ()
 ...
 * @details  Reading nunchuk value and getting joystick and accelerometer
 * values
 */
void
nunchuk_read ()
