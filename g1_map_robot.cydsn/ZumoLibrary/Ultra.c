/**
 * @file    Ultra.c
 * @brief   Basic methods for operating ultrasonic sensor. For more details,
 * please refer to Ultra.h file.
 ...
 * @details  Measuring reflecting time to decide distance between Zumobot and
 * obstacle
 */
  ...
  if (UltraHandle == NULL)
    {
      ...
      xTaskCreate (UltraSonicTask, "Ultra", configMINIMAL_STACK_SIZE, NULL,
                   tskIDLE_PRIORITY + 3, &UltraHandle);
    }
}
